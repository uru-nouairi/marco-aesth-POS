...
export const LoadingScreen = ({
  ...
  return (
    <section className={cn("min-h-screen w-full bg-marco-luxe flex items-center justify-center px-6", className)}>
      <div className="glass-panel max-w-md w-full text-center space-y-5 p-10">
        ...
        <div className="space-y-2">
          <p className="text-sm uppercase tracking-[0.4em] text-foreground/60">Marco Aesthetics POS</p>
